...
namespace {
  using LabelElement = growing_balls::DataStorage<growing_balls::TextInput::OsmId>::Element;
  
  LabelElement element_from(growing_balls::TextInput::PointOfInterest poi) {
...
{
  growing_balls::TextInput::PointOfInterest p(
    "48.00000000000000000 11.90000000000000036 0 180.000 25873009 'Bayern' 1.000");
