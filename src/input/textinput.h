...
public:
  ...
  public:
    PointOfInterest(Coord_Lat lat, Coord_Lon lon, FontFactor f_fac, Label lbl, OsmId id, Priority prio, Radius rad) : m_lat(lat), m_lon(lon), m_font_fac(f_fac), m_label(lbl), m_osmid(id), m_priority(prio), m_radius(rad) {};
